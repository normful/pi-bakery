...
| `initialRenameTrigger` | `string` | `"first-input"` | पहला नाम बदलना कब ट्रिगर होता है：<br><ul><li>`"first-input"` — पहला prompt भेजने के बाद</li><li>`"first-agent-settled"` — पहला LLM रन पूरा होने के बाद（पहली `agent_settled` घटना के बाद）。</li></ul> |
| `language` | `string` | `"en"` | इनमें से एक：`en`、`es`、`de`、`fr`、`it`、`nl`、`pt`/`pt-BR`/`pt-PT`、`id`、`vi`、`tr`、`pl`、`uk`、`fa`、`ar`、`hi`、`zh`/`zh-CN`/`zh-Hans`、`zh-Hant`/`zh-TW`/`zh-HK`、`ja`、`ko`、`th` |
| `namingContextDepth` | `string` | `"recent-user-messages"` | प्रत्येक नाम बदलने वाले prompt में LLM को कितनी बातचीत भेजी जाती है：<br><ul><li>`"first-user-message"` — केवल पहला उपयोगकर्ता संदेश</li><li>`"recent-user-messages"` — पहला उपयोगकर्ता संदेश अंतिम 3 उपयोगकर्ता संदेशों के साथ</li><li>`"full-conversation"` — पूरी बातचीत（उपयोगकर्ता，सहायक，टूल कॉल और परिणाम），लगभग 60k अक्षरों तक सीमित，जिसमें शुरुआत（मुख्य इरादा）और नवीनतम अंत दोनों को बनाए रखा गया है</li></ul> |
| `namingModel` | `string` | `""` | नाम बदलने वाले LLM कॉल के लिए `provider/modelId` ओवरराइड।उदाहरण：`"openrouter/nvidia/nemotron-3-nano-30b-a3b:free"`।खाली छोड़ें ताकि कॉन्फ़िगर्ड Pi डिफ़ॉल्ट मॉडल और प्रदाता का उपयोग किया जा सके। |
| `namingStyle` | `string` | `"natural"` | दोनों नामों के लिए उपयोग किया जाने वाला नामकरण शैली：<br><ul><li>`"natural"` — स्वतंत्र वाक्य</li><li>`"slug"` — छोटे अक्षर हाइफ़न से अलग।</li><li>`"topic-project"` — `<विषय>｜<परियोजना>`，वर्तमान कार्य निर्देशिका से व्युत्पन्न परियोजना</li></ul> |
| `replaceExistingName` | `string` | `"always"` | मौजूदा Pi सत्र नाम，tmux विंडो नाम，herdr पैनल/टैब नाम，zellij पैनल/टैब नाम को कब अधिलेखित किया जाए：<br><ul><li>`"always"` — हमेशा अधिलेखित करें</li><li>`"never"` — कभी अधिलेखित न करें</li></ul> |
